...
ActiveRecord::Schema.define(version: 2021_10_28_144123) do
  ...
  create_table "private_messages", force: :cascade do |t|
    t.text "content"
    t.bigint "sender_id"
    t.bigint "join_table_message_recipient_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["join_table_message_recipient_id"], name: "index_private_messages_on_join_table_message_recipient_id"
